package day31_Constrcutors.scrumTask;
...
public class MyScrumTeam {
    ...
    public static void main(String[] args) {
        ...
        Tester tester4 = new Tester("Lala",23,"SDET",155000);

        Tester [] testers = {tester2,tester3,tester4};


        // 5 developers objects
        Developer developer1 = new Developer("Olga",22,"JavaDeveloper",125000);
        Developer developer2 = new Developer("Aygun",39,"Java Master",185000);
        Developer developer3 = new Developer("Tunc",28,"Sofwa Developer",135000);
