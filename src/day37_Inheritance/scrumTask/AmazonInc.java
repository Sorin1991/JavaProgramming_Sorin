...
public class AmazonInc {
    ...
    public static void main(String[] args) {
        ...
        Developer developer2 = new Developer("Allison",18,'F',"Junior Java Developer",9,140000,company);
        Developer developer3 = new Developer("Tom",26,'M',"Java Developer",10,150000,company);
        Developer developer4 = new Developer("Manas",40,'M',"Full stack Developer",11,160000,company);
        Developer developer5 = new Developer("Evelyn",30,'F',"JS Developer",14,160000,company);
