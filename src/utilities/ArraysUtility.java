...
public class ArraysUtility {
    ...
    public static boolean contains(int[]array, int element){
        ...
        for (int each : array) {
            if(each==element){   // if any array's element is matching with the given element,it means the given elements is matching
                result=true;
    ...
    //method called addInteger that can add an Integer  after the  last index of an integer array
    ...
    // method called addDouble that can add a double after the last index of a double array
    ...
    // method called addString that can add a String after the last index of a String array
    public static String [] addElement(String[] array,String element){
        ...
        // result[i] = element;  // same approach

        return result;
    }

    //method called addChar that can add a char after last index of a char array
