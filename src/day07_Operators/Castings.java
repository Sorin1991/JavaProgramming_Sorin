...
public class Castings {
    public static void main(String[] args) {
        ...
        float num5 = averageScore;        // no casting at all
...
/*
1.1 declare a variable of float averageScore and initialize it to 20.5
1.2 declare the folloing variables and assign averageScore to each of them :
 byte num1;
 short num2;
 int num3;
 long num4;
